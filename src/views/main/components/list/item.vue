  ...
  >
    <div class="relative w-full rounded cursor-zoom-in group">
      ...
      <div
        ...
        rounded duration-300 group-hover:opacity-100 xl:block"
      >
    ...
    <!-- 標題 -->
    <p  
      class="text-sm mx-1 font-bold text-zinc-900 dark:text-zinc-300 line-clamp-2 px-1"
    >
      {{data.title}}
    </p>
    <!-- 作者 -->
